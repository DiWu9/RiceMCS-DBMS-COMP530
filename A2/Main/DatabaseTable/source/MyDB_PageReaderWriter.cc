...
MyDB_PageReaderWriter :: MyDB_PageReaderWriter (MyDB_BufferManagerPtr mgrPtr, MyDB_TablePtr tablePtr, size_t ithPage) {
	this->myMgr = mgrPtr;
...
bool MyDB_PageReaderWriter :: append (MyDB_RecordPtr appendMe) {
	void * toAppend = &this->myPageHead->recs[this->myPageHead->offsetToEnd];
